...
def build():
    ...
    method='<h1>Frozen method</h1><div class="card"><h2>NoDip</h2><div class="small">NIFTY, 09:35 IST; nearest listed expiry; ATM near legs; adjacent far strikes; CBR=(Far CE/Near CE)/(Far PE/Near PE); trade only when CBR≤1.20; BUY Near PE, SELL Near CE, BUY Far CE, SELL Far PE; 2-point adverse slippage; exit previous session 15:20 IST.</div></div><div class="card"><h2>MC-RQ6-v1</h2><div class="small">D3 09:30; 756 historical finite daily log returns; 5,000 IID paths; seed 756; 3-session horizon; P20/P35/P65/P80; BUY 1 P35 PE, SELL 2 P20 PE, BUY 1 P65 CE, SELL 2 C80; gross MC-EV&gt;0; expiry settlement; 2-point adverse slippage.</div></div><div class="card"><h2>Scientific controls</h2><div class="small">Point-in-time data only; source snapshots and hashes; configuration fingerprint lock; append-only ledgers; no synthetic live quotes; manual runs are diagnostic by design; no live broker orders.</div></div>'
